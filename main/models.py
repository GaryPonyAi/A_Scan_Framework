...
class toollist(models.Model):
    ...
    toolname=models.CharField(u'Tool_name',max_length=256)
    tooltxt=models.TextField(u'detail')
    pub_time=models.DateTimeField(u'Issue_time',auto_now_add=True,editable=True)
    update_time=models.DateTimeField(u'Update_time',auto_now=True,null=True)
    is_del = models.BooleanField(default=0)  # 1是删除，0是未删除

    def __str__(self):
        return 'tool {}'.format(self.toolname)
